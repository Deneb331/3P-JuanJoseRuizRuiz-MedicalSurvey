...
class Question:
    ...
    """
    def __init__(self, question, valid, answers):
...
question_list = [
    Question("What is your first name?", "text", None),
    Question("What is your last name?", "text", None),
    Question("What is your blood type?", "options", ["1. A+", "2. A-", "3. B+", "4. B-", "5. O+", "6. O-", "7. AB+", "8. AB-"]),
    Question("How healthy do you consider yourself on a scale of 1 to 10?", "num10", None),
    ...
    Question("Do you have any chronic diseases?", "text", None),
    Question("Do you have any hereditary conditions/diseases?", "text", None),
...
def question_trigger(current_question):
    ...
    if current_question.valid == "text":
        user_answer = input("\n")
        if question_validation(user_answer, "text"):
...
def question_validation(answer, valid_cond):
    """
